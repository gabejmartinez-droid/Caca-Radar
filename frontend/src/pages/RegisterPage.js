      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        ...
        <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm p-6">
          ...
          <div className="mt-4 space-y-2">
            ...
            />
            {showAppleSignIn && (
              <button type="button" onClick={handleAppleLogin} disabled={loading} className="w-full flex items-center justify-center gap-2 border border-[#8D99AE]/20 rounded-xl py-3 bg-black text-white hover:bg-gray-900 transition-colors disabled:opacity-60" data-testid="apple-register-btn">
